...
class DataframeWrapper:
    ...
    class _NormalizedWrapper:
        ...
        def make_relative(self, inplace: bool = False):
            ...
            # Convert feature columns to float to support floating point relative frequencies in pandas 2.0+
            features_list = list(self._top.features)
            self.dataframe[features_list] = self.dataframe[features_list].astype(float)
