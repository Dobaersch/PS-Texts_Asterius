...
class BaseSiameseModule(pl.LightningModule):
    def __init__(
        ...
        self.hparams["optim"] = optim
        self.hparams["learning_rate"] = learning_rate
        self.hparams["label_encoder"] = label_encoder
        self.hparams["miner_for_dev"] = miner_for_dev
        self.hparams["pos_strategy"] = pos_strategy
        self.hparams["neg_strategy"] = neg_strategy
        self.hparams["batch_size_linear"] = batch_size_linear
